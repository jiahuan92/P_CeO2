...
% PxOyHz/CeO2
energy =[
    -1044.24273854793 % P1O4H   (x=1, y=4, z=1)
    -1053.46730896426 % P1O4H3 (x=1, y=4, z=3)
    -1067.4338541254178 % P2O6H2 (x=2, y=6, z=2)
    -1076.653632353574 % P2O7H4 (x=2, y=7, z=4)
    -1100.13168630967 % P3O10H5 (x=3, y=10, z=5)
    ];
...
%%
energy_O2 = -6.08387398216266;
energy_H2O = -10.0864804842095   
energy_CeO2 = -1017.20013926025; 
energy_PO4H3 = -141.60124425513072/4; 
